---
title: 如何在Cloudflare搭建短链接服务
date: 2025-12-03 13:23:21
tags:
  - Workers
---

使用 Cloudflare Workers + KV 搭建安全短链接服务，虽然我还不知道短链接对我的工作和生活有什么帮助，本着有成熟的实践，自己也做一套罢，非说新颖的地方就是我还制作了针对 chrome 和 edge 浏览器的扩展程序，在浏览器里右键，可以直接选择生成当前 web 的短链接。
